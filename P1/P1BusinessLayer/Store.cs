   ...
   public class Store : IStore
    {
        ...
        public P1TestDbContext _context;

        /// <summary>
        /// Constructor for business class that takes a Db context
        /// </summary>
        /// <param name="context">Db context</param>
        public Store(P1TestDbContext context)
        {
            this._context = context;
        }

        /// <summary>
        /// Returns a boolean value corresponding to the existence of a user with the given username and password
        /// </summary>
        ...
        {
            Customer loginUser;
            loginUser = _context.Customers.Where(x => x.Username == usn && x.Password == pwd).FirstOrDefault();
        ...
        public bool Register(Customer customer)
        {
            try
            {
                _context.Add(customer);     // add the new object to the database
                _context.SaveChanges();      // save and update changes
